...
st.markdown("""
    ...
    /* ===== WRAPPER SECTION ===== */
    .welcome-section {
        background: linear-gradient(135deg, #f3fff9 0%, #e9f6ff 100%);
        border-radius: 18px;
        padding: 70px 60px;
...
with st.container():
    ...
    with col1:
        st.markdown("<span class='welcome-badge'>🌱 Selamat Datang di Masa Depan</span>", unsafe_allow_html=True)
        st.markdown("<h1 class='welcome-title'>AI Flower Vision</h1>", unsafe_allow_html=True)
        st.markdown("<p class='welcome-subtitle'>Teknologi Neural Network untuk Identifikasi Bunga</p>", unsafe_allow_html=True)
        st.markdown("""
            <p class='welcome-desc'>
            Bergabunglah dalam perjalanan menakjubkan untuk menjelajahi dunia bunga menggunakan teknologi 
            kecerdasan buatan terdepan. Temukan, identifikasi, dan pelajari berbagai spesies bunga 
            dengan cara yang belum pernah ada sebelumnya.
            </p>
        """, unsafe_allow_html=True)
        ...
        <div class='feature-container'>
            <div class='feature-box'>
                ...
                <div class='feature-title'>Deteksi Objek</div>
                <div class='feature-sub'>Identifikasi bagian bunga</div>
            </div>
            <div class='feature-box'>
                <div class='feature-icon'>🌸</div>
                <div class='feature-title'>Klasifikasi</div>
                <div class='feature-sub'>Kenali spesies bunga</div>
            </div>
            <div class='feature-box'>
                <div class='feature-icon'>🤖</div>
                <div class='feature-title'>AI Learning</div>
                <div class='feature-sub'>Teknologi neural network</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
